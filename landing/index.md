...
|                                        |                                            |
| :------------------------------------: | :----------------------------------------: |
| ![Elections Overview](screenshot1.png) |   ![Candidate Details](screenshot2.png)    |
| ![Committee Tracking](screenshot3.png) | ![Contribution Analytics](screenshot4.png) |
...
[Download the Android APK (Release)](contribs-release.apk)

---

_Contribs.app is a non-partisan project dedicated to open data and democratic accountability._
