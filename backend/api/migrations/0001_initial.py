    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['CAND_NAME', 'CAND_ELECTION_YR'], name='api_candida_CAND_NA_28d097_idx')],
            },
        ),
        migrations.CreateModel(
            name='Committee',
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [
                    models.Index(fields=['contributor', 'committee'], name='api_contrib_contrib_4206e7_idx'),
                    models.Index(fields=['receipt_date', 'amount'], name='api_contrib_receipt_c1c4f5_idx'),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('SUB_ID', models.BigIntegerField(help_text='Unique row ID (required).', primary_key=True, serialize=False, unique=True, verbose_name='FEC record number')),
            ],
            options={
                ...
                'indexes': [
                    models.Index(fields=['CMTE_ID'], name='api_feccont_CMTE_ID_c76949_idx'),
                    models.Index(fields=['NAME'], name='api_feccont_NAME_894e63_idx'),
                    models.Index(fields=['TRANSACTION_DT'], name='api_feccont_TRANSAC_5be7bc_idx'),
                    models.Index(fields=['TRANSACTION_AMT'], name='api_feccont_TRANSAC_f74751_idx'),
                ],
            },
        ),
    ]
